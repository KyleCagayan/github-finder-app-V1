...
export default function User() {
  ...
  }, []); // the [] makes it so argument only runs once.
        ...
        <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
            <div className="stat">
                <div className="stat-figure text-secondary">
                    <FaUsers className="tet-3xl md:text-5xl"/>
                </div>
            ...
            <div className="stat">
                <div className="stat-figure text-secondary">
                    <FaUserFriends className="tet-3xl md:text-5xl"/>
                </div>
                <div className="stat-title pr-5">
                    Following
                </div>
            ...
            <div className="stat">
                <div className="stat-figure text-secondary">
                    <FaCodepen className="tet-3xl md:text-5xl"/>
                </div>
                <div className="stat-title pr-5">
                    Public Repos
                </div>
            ...
            <div className="stat">
                <div className="stat-figure text-secondary">
                    <FaStore className="tet-3xl md:text-5xl"/>
                </div>
                <div className="stat-title pr-5">
                    Public Gists
                </div>
